          ...
          {images.length > 0 ? (
            <div className="relative aspect-square md:aspect-[4/3] w-full group bg-muted">
              ...
              {hasMultipleImages && (
                <>
                  {/* 图片计数器 */}
                  <div className="absolute bottom-2 right-2 rounded-full bg-black/70 px-2 py-1 text-xs text-white opacity-0 shadow-sm transition-opacity group-hover:opacity-100">
